...
export const FANDOMS = [
  ...
  { id: "neverland", label: "Neverland", group: "(G)I-DLE" },
  { id: "exol", label: "EXO-L", group: "EXO" },
  { id: "my", label: "MY", group: "aespa" },
  { id: "dive", label: "DIVE", group: "IVE" },
  { id: "bunnies", label: "Bunnies", group: "NewJeans" },
  { id: "nswer", label: "NSWER", group: "NMIXX" },
  { id: "revelup", label: "ReVeluv", group: "Red Velvet" },
  { id: "monbebe", label: "MONBEBE", group: "MONSTA X" },
  { id: "igot7", label: "IGOT7", group: "GOT7" },
