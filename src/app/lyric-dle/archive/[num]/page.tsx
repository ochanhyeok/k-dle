...
export async function generateMetadata({ params }: { params: Promise<{ num: string }> }): Promise<Metadata> {
  ...
  return {
    title: `Lyric-dle Archive #${num}`,
    description: `Play past Lyric-dle puzzle #${num}. Can you name the K-Pop song from translated lyrics?`,
    alternates: { canonical: `${SITE_URL}/lyric-dle/archive/${num}` },
    openGraph: {
      title: `Lyric-dle Archive #${num} | K-Dle`,
      description: `Play past Lyric-dle puzzle #${num}. Name the song!`,
      url: `${SITE_URL}/lyric-dle/archive/${num}`,
    },
  };
}
